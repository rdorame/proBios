...
<div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            @if(Auth::user()->admin == 'si')
              ...
              <a href="{{ route('admin.orders')}}" type="button" name="button" class="btn btn-success">Ordenes</a>
              <a href="{{ route('admin.users')}}" type="button" name="button" class="btn btn-success">Usuarios</a>
              <a href="{{ URL::to('products') }}" type="button" name="button" class="btn btn-success">Productos</a>
              <a class="btn btn-small btn-info" href="{{ URL::to('user/' . $user->id . '/edit') }}">Editar perfil</a>
            @else
              <h2>{{ $user->name }} </h2>
            @endif
            <br>
